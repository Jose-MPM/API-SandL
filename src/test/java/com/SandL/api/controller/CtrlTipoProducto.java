...
public class CtrlTipoProducto{
	 ...
	 */
	@GetMapping
	public ResponseEntity<List<TipoProducto>> getTiposProductos() {
		return new ResponseEntity<>(serviceInventario.getInventarios(), HttpStatus.OK);
	}
    ...
    public ResponseEntity<TipoProducto> getTipoProducto(@PathVariable Long idTipoProducto) {
        return new ResponseEntity<>(serviceInventario.getInventario(idTipoProducto), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> updateTipoProducto(@PathVariable Long idTipoProducto, 
       ...
       if(bindingResult.hasErrors()) {
        ...
        return new ResponseEntity<TipoProducto>(inventarioAEditar, HttpStatus.OK);
    }

    @DeleteMapping("/{idTipoProducto}")
	//@ResponseStatus(HttpStatus.NO_CONTENT)
    public ResponseEntity<String> deleteTipoProducto(@PathVariable Long idTipoProducto) {
        //Map<String,Object> response = new HashMap<>();
